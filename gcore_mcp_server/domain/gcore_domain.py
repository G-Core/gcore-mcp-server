    ...
    def get_toolset_definitions() -> Dict[str, List[str]]:
        ...
        return {
            ...
            "security": [
                ...
                # Secrets
                "cloud.secrets.upload_tls_certificate",
                "cloud.secrets.list",
                "cloud.secrets.get",
            ...
            "cdn": [
                ...
                "cdn.cdn_resources.get",
                "cdn.cdn_resources.create",
                "cdn.cdn_resources.update",
                "cdn.cdn_resources.replace",
                "cdn.cdn_resources.delete",
                "cdn.cdn_resources.purge",
                "cdn.cdn_resources.prefetch",
                "cdn.cdn_resources.rules.list",
                "cdn.cdn_resources.rules.get",
                "cdn.cdn_resources.rules.create",
                "cdn.cdn_resources.rules.update",
                "cdn.cdn_resources.rules.replace",
                "cdn.cdn_resources.rules.delete",
                # CDN Origin Groups
